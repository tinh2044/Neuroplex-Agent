...
class KBDBManager:
    ...
    def __init__(self, agent_config: AgentConfig):
        ...
        self.db_manager = DatabaseManager(agent_config)
        self.file_manager = FileManager(agent_config)
        self.node_manager = NodeManager(agent_config)
    ...
    def create_database(self, db_id: str, name: str, description: str, embed_model: str = None, dimension: int = None, metadata: dict = None) -> dict:
        """
    ...
    def add_file(self, db_id: str, file_id: str, filename: str, path: str, file_type: str, status: str = "waiting") -> dict:
        """
    ...
    def get_files_by_database(self, db_id: str) -> list:
        """
